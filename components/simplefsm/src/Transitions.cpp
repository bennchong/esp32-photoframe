...
Transition::Transition(State* from, State* to, int event_id, CallbackFunction on_run /* = NULL */,
                       String name /* = "" */, GuardCondition guard /* = NULL */)
{
...
TimedTransition::TimedTransition(String from, String to, int interval,
                                 CallbackFunction on_run /* = NULL */, String name /* = "" */,
...
Transition::Transition(String from, String to, int event_id, CallbackFunction on_run /*= NULL */,
                       String name /* = "" */, GuardCondition guard /*= NULL */)
{
    setup(from, to, event_id, on_run, name, guard);
}
...
void Transition::setup(State* from, State* to, int event_id, CallbackFunction on_run /* = NULL */,
                       String name /* = "" */, GuardCondition guard /* = NULL */)
{
    this->from = from;
    this->to = to;
...
void Transition::setup(String from, String to, int event_id, CallbackFunction on_run /* = NULL */,
                       String name /* = "" */, GuardCondition guard /* = NULL */)
{
...
TimedTransition::TimedTransition(State* from, State* to, int interval,
                                 CallbackFunction on_run /* = NULL */, String name /* = "" */,
                                 GuardCondition guard /* = NULL */)
    : TimedTransition()
{
...
void TimedTransition::setup(State* from, State* to, int interval,
                            CallbackFunction on_run /* = NULL */, String name /* = "" */,
                            GuardCondition guard /* = NULL */)
{
    this->from = from;
...
void TimedTransition::setup(String from, String to, int interval,
                            CallbackFunction on_run /* = NULL */, String name /* = "" */,
                            GuardCondition guard /* = NULL */)
{
    this->fromStateName = from;
