...
State::State(String name, CallbackFunction on_enter, CallbackFunction on_state,
             CallbackFunction on_exit, bool is_final /* = false */)
{
...
void State::setup(String name, CallbackFunction on_enter, CallbackFunction on_state,
                  CallbackFunction on_exit, bool is_final /* = false */)
{
    this->name = name;
