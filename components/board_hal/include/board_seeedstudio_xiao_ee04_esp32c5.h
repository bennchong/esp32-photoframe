#ifndef BOARD_SEEEDSTUDIO_XIAO_EE04_ESP32C5_H
#define BOARD_SEEEDSTUDIO_XIAO_EE04_ESP32C5_H

#include "driver/gpio.h"

// Board Info
#define BOARD_HAL_NAME "seeedstudio_xiao_ee04_esp32c5"
#define BOARD_HAL_TYPE BOARD_TYPE_SEEEDSTUDIO_XIAO_EE04_ESP32C5
...
#define BOARD_HAL_EPD_CS_PIN ((gpio_num_t) 44)
#define BOARD_HAL_EPD_RST_PIN ((gpio_num_t) 38)
#define BOARD_HAL_EPD_BUSY_PIN GPIO_NUM_4
#define BOARD_HAL_EPD_ENABLE_PIN ((gpio_num_t) 43)

// Display Configuration
#define BOARD_HAL_DISPLAY_ROTATION_DEG 0

#endif  // BOARD_SEEEDSTUDIO_XIAO_EE04_ESP32C5_H
